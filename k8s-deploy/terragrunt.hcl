terraform {
  source = "git::https://github.com/thitsax/mojaloop-iac-modules.git//terraform/${get_env("cloud_platform")}/${get_env("k8s_cluster_module")}?ref=${get_env("iac_terraform_modules_tag")}"
}
